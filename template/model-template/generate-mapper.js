...
import { ${capitalizeFirstLetter(entityName)}Raw } from '../../../../contexts/${entityName}';

export function to${capitalizeFirstLetter(entityName)}Raw(${entityName.toLowerCase()}: ${capitalizeFirstLetter(entityName)}): ${capitalizeFirstLetter(entityName)}Raw {
  return {
